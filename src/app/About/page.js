...
<div className="flex flex-col lg:flex-row gap-10 p-6 lg:p-12 bg-white">
  ...
  <div className="ab-card bg-[#e0e0e0]  py-4 px-6 sm:px-10 rounded-3xl shadow-sm space-y-4">
    ...
    {/* <p className="text-gray-600">
      We blend traditional teaching with modern tools to create a dynamic learning experience that sticks. Whether it's coding, math, or communication skills — our courses are crafted to spark curiosity and confidence in every student.
    </p> */}
  </div>
  ...
  <div className="ab-card bg-[#e0e0e0] py-4 px-6 sm:px-10 rounded-3xl shadow-sm space-y-4">
    ...
    {/* <p className="text-gray-600">
      Our platform is parent-approved and globally trusted. With flexible schedules, certified educators, and regular progress tracking, we offer peace of mind for families and outstanding results for learners.
    </p> */}
  </div>
  ...
  <div className="ab-card bg-[#e0e0e0] py-4 px-6 sm:px-10 rounded-3xl  space-y-4">
    ...
    {/* <p className="text-gray-600">
      We believe that learning shouldn’t be limited by walls or timetables. With 24/7 access to resources and classes from the comfort of your home, The Study Wave empowers learners from every corner of the world.
    </p> */}
  </div>
