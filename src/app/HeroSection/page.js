  ...
  <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-center z-10 gap-8">
    ...
    <div className="max-w-2xl text-center lg:text-left">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-black leading-tight">
       ...
       <span className="text-orange-500 font-extrabold text-[60px]">Shaping Futures</span> ,<br /> One Class at a Time.
      </h1>
<p className={`text-black ${DynaPuffs.className}`}>"Where Curiosity Meets Clarity."</p>

      <p className="mt-4 sm:mt-6 text-gray-600 text-base sm:text-lg">
      At The Study Wave, we offer personalized 1:1 live sessions that make learning simple and engaging. With expert tutors and a focus on concept clarity,<span className="text-orange-400">we help students not just learn — but truly thrive.

</span>
      </p>
      
      <div type="button" className="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Book Free Demo Class</div>
